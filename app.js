...
function authHTML() {
  return `<div class="auth-wrap"><div class="auth card"><h2>Doomstalk</h2><input id="regUsername" placeholder="Username"/><input id="regEmail" type="email" placeholder="Email"/><input id="regPassword" type="password" placeholder="Password"/><button id="register" class="primary">Create account</button><hr/><input id="loginEmail" type="email" placeholder="Email"/><input id="loginPassword" type="password" placeholder="Password"/><button id="login">Login</button><hr/><button id="googleLogin">Continue with Google</button></div></div>`;
}
